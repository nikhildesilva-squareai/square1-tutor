...
// ─── Career outcomes (the WHY) ────────────────────────────────────────────────
const ROLES = [
  { title: "AI Engineer",            track: "Generative AI",         salary: "£75–120k" },
  { title: "Cybersecurity Engineer", track: "Cybersecurity",         salary: "£70–110k" },
  { title: "ML Engineer",            track: "Machine Learning",      salary: "£80–130k" },
  { title: "Full Stack Engineer",    track: "Full Stack Development", salary: "£60–110k" },
  { title: "Data Engineer",          track: "Data Engineering",      salary: "£70–115k" },
  { title: "Cloud Engineer",         track: "Cloud & DevOps",        salary: "£75–120k" },
];
...
function OutcomeCard({
  ...
  return (
    <div
      className="relative group rounded-3xl p-6 lg:p-8 transition-all duration-700 will-change-transform border"
      style={{
  ...
  return (
    <div className="relative w-full overflow-hidden py-2">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 w-16 sm:w-32 z-10"
        style={{ background: "linear-gradient(90deg, #050B14 0%, transparent 100%)" }} />
      <div className="pointer-events-none absolute inset-y-0 right-0 w-16 sm:w-32 z-10"
        style={{ background: "linear-gradient(270deg, #050B14 0%, transparent 100%)" }} />
      ...
      <div className="flex gap-8 animate-marquee whitespace-nowrap">
        {items.map((role, i) => (
          <div key={`${role.title}-${i}`} className="flex items-center gap-3 shrink-0">
            ...
            <span className="text-sm sm:text-base font-bold text-white">{role.title}</span>
...
export function JourneyHook() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <p className="text-center text-base sm:text-lg text-slate-400 max-w-2xl mx-auto mb-10">
            Cybersecurity Engineer. ML Engineer. Cloud Architect. Whatever role you&apos;re targeting — Square 1 takes you from where you are now, to landing the offer.
          </p>
          ...
          {/* Big "This is you in 6 months" sub-headline */}
      ...
      {/* DIVIDER */}
      {/* ════════════════════════════════════════════════════════════════════════ */}
      <div className="py-10 px-4" style={{ background: "#050B14" }}>
