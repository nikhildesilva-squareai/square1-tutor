...
// ═══════════════════════════════════════════════════════════════════════════════
// "Latest from the Newsroom" — landing-page strip. Server component; renders
// NOTHING until at least one article is published, so the landing page never
// shows an empty news section.
// ═══════════════════════════════════════════════════════════════════════════════
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {articles.map((a) => (
            <Link key={a.id} href={`/newsroom/${a.slug}`}
              className="group rounded-2xl border border-slate-200 bg-white p-5 flex flex-col transition-all hover:-translate-y-0.5 hover:border-brand/30 hover:shadow-[0_12px_30px_rgba(0,86,206,0.07)]">
