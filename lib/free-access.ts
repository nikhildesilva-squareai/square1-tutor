...
/** When the window closes (Australia/Sydney end-of-day). 12-week free test for
 *  100 students, opened 2026-06-26 → closes 2026-09-18. */
export const FREE_ACCESS_ENDS_AT =
  process.env.NEXT_PUBLIC_FREE_ACCESS_ENDS_AT ?? "2026-09-18T23:59:59+10:00";
