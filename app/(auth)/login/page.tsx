...
export default function LoginPage() {
  ...
  const brandPanel = (
    <div className="hidden lg:flex lg:w-[480px] flex-col justify-between p-12 bg-brand-deep text-ink-on-dark">
      <div>
        <span className="text-sm font-semibold text-brand-light">Square 1 AI</span>
        <h1 className="mt-8 text-4xl font-bold leading-tight">
          Learn it.<br />Build it.<br />Ship it.
        </h1>
      ...
      <div className="space-y-5">
        {[
          ...
          { n: "03", label: "Choose your learning plan" },
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-surface-soft">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden mb-8">
            <span className="text-sm font-semibold text-brand">Square 1 AI · Tutor</span>
          </div>
