    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex-1 px-4 pb-16 sm:px-6">
        ...
        <section className="mx-auto max-w-5xl">
          <div className="relative overflow-hidden rounded-2xl border border-[#D4F0FC] bg-[#ECF8FE] px-6 py-12 text-center sm:px-10 sm:py-14">
            <span aria-hidden className="pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full bg-white/40 blur-3xl" />
            <div className="relative mx-auto max-w-2xl">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-[#CCE1FF] bg-white px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-[0.12em] text-[#0056CE]">
              ...
              <p className="mx-auto mt-4 max-w-md text-[15px] leading-relaxed text-slate-500 sm:text-lg">
              ...
              <div className="relative mx-auto mt-8 max-w-md">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-[#D4F0FC] bg-white pl-12 pr-4 text-[15px] text-slate-900 shadow-sm outline-none transition-shadow placeholder:text-slate-400 focus:border-[#0056CE] focus:ring-4 focus:ring-[#0056CE]/15"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {filtered.map((s) => (
                <Link
                  ...
                  className="group flex flex-col rounded-2xl border border-[#E8EEF5] bg-white p-5 shadow-[0_1px_2px_rgba(21,47,84,0.04)] transition-all hover:-translate-y-1 hover:border-[#D8E2ED] hover:shadow-[0_14px_26px_-12px_rgba(21,47,84,0.20)]"
                >
                  <span
                    className="inline-flex h-12 w-12 items-center justify-center rounded-xl"
                    style={{ background: `${s.color}14`, border: `1px solid ${s.color}2b` }}
                  >
                    <CourseIcon slug={s.slug} size={24} color={s.color} />
                  </span>
                  <h3 className="mt-4 text-[17px] font-bold leading-snug text-slate-900">{s.title}</h3>
                  <p className="mt-0.5 text-sm font-semibold" style={{ color: s.color }}>{s.role}</p>
