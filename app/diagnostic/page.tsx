...
/* Each line is short enough to hold a single row at 390px. The longer phrasing
   wrapped to two lines apiece, which cost ~64px of the mobile fold for no
   extra meaning. */
const PAYOFF = [
  "A topic-by-topic skill breakdown",
  "Your strengths and the gaps to close",
  "How ready you are for the role",
  "What to learn next, from real curriculum",
];
    ...
    <div className="flex min-h-dvh flex-col bg-white">
      ...
      <main className="flex-1 pb-20">
        ...
        <section className="mx-auto max-w-6xl px-5 sm:px-6">
          {/* Vertical rhythm here is deliberately tight: the hero has to leave
              the first row of track cards visible without scrolling, so every
              step below is sized to that constraint rather than to comfort. */}
          <div className="relative overflow-hidden rounded-3xl border border-[#DCEBFB] bg-gradient-to-br from-[#F4F9FF] via-white to-[#EEF6FF] px-5 py-6 sm:px-9 sm:py-8">
            ...
            <div className="relative grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
              ...
              <div>
                ...
                <h1 className="mt-3.5 text-[26px] font-extrabold leading-[1.08] tracking-[-0.025em] text-slate-900 sm:mt-4 sm:text-[34px] lg:text-[39px] lg:leading-[1.06]">
                  See where you stand
                  <span className="block text-[#0056CE]">and what to learn next.</span>
                </h1>

                {/* Trimmed to two lines — the third line cost more height than
                    the words were worth. */}
                <p className="mt-2.5 max-w-md text-[14px] leading-relaxed text-slate-600 sm:mt-3 sm:text-[15px]">
                  Five questions on the track you&apos;re aiming for, and a real skill
                  breakdown the moment you finish. No account, no email.
                </p>
                ...
                <a
                  href="#tracks"
                  className="mt-5 inline-flex h-11 items-center gap-2 rounded-xl bg-[#0056CE] px-5 text-[14.5px] font-bold text-white shadow-[0_10px_22px_-10px_rgba(0,86,206,0.8)] transition-all hover:-translate-y-0.5 hover:bg-[#0049AE] hover:shadow-[0_14px_28px_-10px_rgba(0,86,206,0.85)]"
                >
                  Pick your track
              ...
              {/* Report preview — schematic on purpose. The bars carry no
                  ...
                  Hidden below sm: on a 390px screen it costs ~370px, which is
                  the difference between landing on track cards and landing on
                  a full screen of hero. The payoff list above carries the same
                  information in words, so nothing is lost but the picture. */}
        ...
        {/* ── Tracks ────────────────────────────────────────────────────── */}
        <section id="tracks" className="mx-auto mt-8 max-w-6xl scroll-mt-6 px-5 sm:px-6">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h2 className="text-[19px] font-extrabold tracking-[-0.02em] text-slate-900 sm:text-[22px]">
...
function ReportPreview() {
  ...
  return (
    <div className="relative">
      <div
        aria-hidden
        className="rotate-[1.2deg] rounded-2xl border border-slate-200/80 bg-white p-4 shadow-[0_28px_54px_-24px_rgba(21,47,84,0.34)] transition-transform duration-300 hover:rotate-0 sm:p-5"
      >
